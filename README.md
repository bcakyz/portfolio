...
[![Site preview](/public/site-preview.png)](https://bcakyz.com)

My design portfolio to showcase a few projects. Built with [Next.js](https://nextjs.org/), [Three.js](https://threejs.org/), and [Framer Motion](https://www.framer.com/motion/). View the [live site](https://bcakyz.com) or check out a live version of the [components storybook](https://storybook.bcakyz.com).
