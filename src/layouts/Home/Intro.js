        ...
        {(visible, status) => (
          <Fragment>
            ...
            <header className={styles.text}>
              <h1 className={styles.name1} data-visible={visible} id={titleId}>
                <DecoderText text="Bekircan Akyuz" delay={300} />
              </h1>
              <h1 className={styles.name} data-visible={visible} id={titleId}>
                <DecoderText text="&#10024; The project is under development &#128736;" delay={900} />
              </h1>
              <Heading level={2} as="h3" className={styles.title}>
